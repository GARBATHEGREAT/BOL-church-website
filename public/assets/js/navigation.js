(function(){
  ...
  function openMenu(){if(!isMobile())return;menu.scrollTop=0;menu.classList.add('open');backdrop.classList.add('open');document.body.classList.add('nav-open');openButton.setAttribute('aria-expanded','true')}
