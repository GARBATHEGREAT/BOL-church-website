...
fs.copyFileSync(path.join(root, 'assets/js/navigation.js'), path.join(dist, 'assets/js/navigation.js'));
...
fs.copyFileSync(path.join(root, 'assets/css/mobile-menu.css'), path.join(dist, 'assets/css/mobile-menu.css'));
